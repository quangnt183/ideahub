...
factory('appData', function() {
	if (!localStorage.appData) localStorage.appData = '{"projects":[{"name": "Juninor Paramedic", "docs": [{"name": "Asset Request", "pages": [{"comments": [], "draws": [], "image": "img/tmp/01HOME.jpg"}]}]},{"name": "epub reader"}]}';
